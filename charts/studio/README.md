...
![Version: 2.7.0-rc.4](https://img.shields.io/badge/Version-2.7.0--rc.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
$ helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.7.0-rc.4
```
...
```console
$ helm install my-release rasa/studio --version 2.7.0-rc.4
```
...
```console
$ helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.7.0-rc.4
```

### From GitHub Helm Repository:

```console
$ helm pull rasa/studio --version 2.7.0-rc.4
```
