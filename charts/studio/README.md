...
![Version: 2.0.3-rc1](https://img.shields.io/badge/Version-2.0.3--rc1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
$ helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.0.3-rc1
```
...
```console
$ helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.0.3-rc1
```
...
| backend.migration | object | `{"enable":true,"image":{"name":"studio-database-migration","pullPolicy":"IfNotPresent"},"waitForIt":false,"waitFotItContainer":{"image":"postgres:17.2"}}` | Define Studio Database Migration job settings |
...
| tag | string | `"1.10.1"` | tag specifies image tag for Studio # Overrides the image tag whose default is the chart appVersion. |
