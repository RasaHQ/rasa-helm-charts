...
```console
$ helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/op-kits --version 0.1.8
```
...
```console
$ helm install my-release rasa/op-kits --version 0.1.8
```
...
```console
$ helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/op-kits --version 0.1.8
```

### From GitHub Helm Repository:

```console
$ helm pull rasa/op-kits --version 0.1.8
```
