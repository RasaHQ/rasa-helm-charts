...
![Version: 1.3.3-rc.2](https://img.shields.io/badge/Version-1.3.3--rc.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 1.3.3-rc.2
```
...
```console
helm install my-release rasa/rasa --version 1.3.3-rc.2
```
...
```console
helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 1.3.3-rc.2
```

### From GitHub Helm Repository:

```console
helm pull rasa/rasa --version 1.3.3-rc.2
```
