...
![Version: 2.3.1-rc.0](https://img.shields.io/badge/Version-2.3.1--rc.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 2.3.1-rc.0
```
...
```console
helm install my-release rasa/rasa --version 2.3.1-rc.0
```
