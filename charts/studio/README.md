...
![Version: 2.4.3-rc.0](https://img.shields.io/badge/Version-2.4.3--rc.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
$ helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.4.3-rc.0
```
...
```console
$ helm install my-release rasa/studio --version 2.4.3-rc.0
```
...
```console
$ helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.4.3-rc.0
```

### From GitHub Helm Repository:

```console
$ helm pull rasa/studio --version 2.4.3-rc.0
```
...
| config.keycloak | object | config.keycloak defines the Keycloak configuration settings. This section configures the authentication and authorization service. | `{"adminPassword":{"secretKey":"KEYCLOAK_ADMIN_PASSWORD","secretName":"studio-secrets"},"adminUsername":"kcadmin","apiClientId":"admin-cli","apiPassword":{"secretKey":"KEYCLOAK_API_PASSWORD","secretName":"studio-secrets"},"apiUsername":"realmadmin","backendClientSecret":{"secretKey":"KEYCLOAK_BACKEND_CLIENT_SECRET","secretName":"studio-secrets"},"clientId":"rasa-studio-backend","realm":"rasa-studio","url":""}` |
...
| config.keycloak.backendClientSecret | object | config.keycloak.backendClientSecret is the client secret for the Keycloak backend client. This secret is used by Studio Backend to authenticate with Keycloak. | `{"secretKey":"KEYCLOAK_BACKEND_CLIENT_SECRET","secretName":"studio-secrets"}` |
