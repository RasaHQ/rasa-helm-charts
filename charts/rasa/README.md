...
```console
helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 2.6.0-rc.0
```
...
```console
helm install my-release rasa/rasa --version 2.6.0-rc.0
```
