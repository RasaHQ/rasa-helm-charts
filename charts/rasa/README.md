...
![Version: 2.0.3-rc.1](https://img.shields.io/badge/Version-2.0.3--rc.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 2.0.3-rc.1
```
...
```console
helm install my-release rasa/rasa --version 2.0.3-rc.1
```
...
```console
helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 2.0.3-rc.1
```

### From GitHub Helm Repository:

```console
helm pull rasa/rasa --version 2.0.3-rc.1
```
