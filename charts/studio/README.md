...
| backend.environmentVariables.DOCKER_IMAGE_TAG | object | `{"value":"europe-west3-docker.pkg.dev/rasa-releases/rasa-plus/rasa-plus:3.7.7"}` | The complete registry URL of the Rasa Plus docker image to be used for training |
