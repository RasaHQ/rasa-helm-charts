...
![Version: 2.4.1-rc.2](https://img.shields.io/badge/Version-2.4.1--rc.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 2.4.1-rc.2
```
...
```console
helm install my-release rasa/rasa --version 2.4.1-rc.2
```
