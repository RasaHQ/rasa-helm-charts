...
![Version: 2.0.11-rc1](https://img.shields.io/badge/Version-2.0.11--rc1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
$ helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.0.11-rc1
```
...
```console
$ helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.0.11-rc1
```
...
| eventIngestion.enabled | bool | `true` | eventIngestion.enabled specifies whether the event ingestion component should be deployed or not |
...
| tag | string | `"1.12.0.dev2"` | tag specifies image tag for Studio # Overrides the image tag whose default is the chart appVersion. |
