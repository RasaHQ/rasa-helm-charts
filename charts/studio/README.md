...
![Version: 2.0.4-rc0](https://img.shields.io/badge/Version-2.0.4--rc0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
```console
$ helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.0.4-rc0
```
...
```console
$ helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/studio --version 2.0.4-rc0
```
...
| tag | string | `"1.11.0"` | tag specifies image tag for Studio # Overrides the image tag whose default is the chart appVersion. |
