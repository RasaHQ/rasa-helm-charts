...
Then point Rasa at the Duckling service. The Duckling service name follows the pattern `<release-name>-duckling`:

```yaml
rasa:
  settings:
    ducklingHttpUrl: "http://my-release-duckling:8000"
```
