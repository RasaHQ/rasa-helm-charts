...
| config.database | object | `{"awsRegion":"","backendDatabaseName":"studio","host":"","iamDbUsername":"","keycloakDatabaseName":"","password":{"secretKey":"DATABASE_PASSWORD","secretName":"studio-secrets"},"port":"5432","preferSSL":"true","queryParams":"","rejectUnauthorized":"","useAwsIamAuth":"","username":""}` | The postgres database instance details for Studio to connect to. This section configures the database connection parameters for Studio. |
...
| config.database.keycloakDatabaseName | string | `""` | The database name for Keycloak user management service. This is used by Keycloak to store its user management data. |
