...
```console
$ helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/op-kits --version 0.1.11
```
...
```console
$ helm install my-release rasa/op-kits --version 0.1.11
```
...
```console
$ helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/op-kits --version 0.1.11
```

### From GitHub Helm Repository:

```console
$ helm pull rasa/op-kits --version 0.1.11
```
