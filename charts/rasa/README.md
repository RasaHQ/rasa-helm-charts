...
```console
helm install my-release oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 1.3.1
```
...
```console
helm install my-release rasa/rasa --version 1.3.1
```
...
```console
helm pull oci://europe-west3-docker.pkg.dev/rasa-releases/helm-charts/rasa --version 1.3.1
```

### From GitHub Helm Repository:

```console
helm pull rasa/rasa --version 1.3.1
```
